...
var multiItemSlider = (function () {
	return function (selector, config) {
		...
		_mainElement = document.querySelector(selector), // основный элемент блока
			...
			_sliderItems = _mainElement.querySelectorAll('.slider-tem'), // элементы (.slider-item)
			_sliderControls = _mainElement.querySelectorAll('.slider-control'), // элементы управления
			_sliderControlLeft = _mainElement.querySelector('.slider-control_left'), // кнопка "LEFT"
